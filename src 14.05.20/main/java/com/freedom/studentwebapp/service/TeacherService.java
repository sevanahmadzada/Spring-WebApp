...
@Service
@Primary //iki class bir interface-i implement etse, interface bilmeyecek hansin gotursun
...
//
        ...
        repository.save(teacherEntity);//yeni assign etdiyin id-ni get edir ashagidaki
